...
func VerifyPassword(passwordEntered string, passwordStored string) (bool, string) {
	err := bcrypt.CompareHashAndPassword([]byte(passwordStored), []byte(passwordEntered))
	if err != nil {
